...
export default function MainSearchRecommend({ mainSearchRecommend, className, handleClick }: MainSearchRecommendProps) {
    ...
    <div>
      {
        displayedItems.length != 0 ? (
          displayedItems.map((carName, index) => {
            ...
            return <div className={`flex relative w-full lg:h-auto h-16 lg:w-3/4 mx-auto ${className}`} key={index}>
              <button 
                onClick={handleClick}
                type="button"
