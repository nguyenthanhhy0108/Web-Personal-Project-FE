      ...
      <div className='mt-9'>
        ...
        <div className='flex items-center mt-3'>
          ...
          <label htmlFor='agreement'>
            Agree with our{' '}
            <button
              onClick={handleClickTermAndCondition}
              className='items-center text-blue-900 hover:underline hover:text-blue-950 dark:text-blue-400 dark:hover:text-blue-500'
            >
