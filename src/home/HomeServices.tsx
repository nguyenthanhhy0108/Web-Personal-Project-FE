  ...
  return (
    <div className='flex flex-col justify-center font-bold gap-10 dark:text-white text-black p-6'>
      ...
      <div className='grid lg:grid-cols-2 grid-cols-1 lg:border-b-2 font-semibold text-xl'>
        ...
        <div
          className={`lg:hidden ${choosenService == 1 ? 'hidden transition-all duration-1000' : ''}`}
        >
          {isLoading ? (
            <Skeleton
              variant='rounded'
            ...
            <CardCarousel cards={otherServices} />
          )}
        </div>
        <button
        ...
        <div
          className={`lg:hidden ${choosenService == 2 ? 'hidden transition-all duration-1000' : ''}`}
        >
          {isLoading ? (
            <Skeleton
              variant='rounded'
            ...
            <CardCarousel cards={mainServices} />
          )}
        </div>
      </div>
