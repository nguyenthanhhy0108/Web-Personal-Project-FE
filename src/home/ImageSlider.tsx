...
export default function ImageSlider() {
  ...
  return (
    <div className='h-[300px] lg:h-[800px] max-w-[1450px] w-screen m-auto pt-6 px-4 relative group'>
      <div
        className='w-full h-full bg-center bg-cover duration-300 rounded-2xl'
        style={{ backgroundImage: `url(${imageLinks[currentImageIndex].url})` }}
      ></div>
      <div
